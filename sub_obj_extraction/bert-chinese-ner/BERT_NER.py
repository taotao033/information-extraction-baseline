...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["B-OBJ", "I-OBJ", "O", "B-SUB", "I-SUB", "B-SUB_OBJ", "I-SUB_OBJ", "X", "[CLS]", "[SEP]"]
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids, predictions, 11, [1, 2, 4, 5, 6, 7], average="macro")
                recall = tf_metrics.recall(label_ids, predictions, 11, [1, 2, 4, 5, 6, 7], average="macro")
                f = tf_metrics.f1(label_ids, predictions, 11, [1, 2, 4, 5, 6, 7], average="macro")
                #
                return {
